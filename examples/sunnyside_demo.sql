...
--   sh examples/sunnyside_export.sh /tmp/sunnyside
--   build/release/duckdb /tmp/sunny.duckdb -c ".read examples/sunnyside_load.sql"
--   build/release/duckdb /tmp/sunny.duckdb -c ".read examples/sunnyside_demo.sql"
