...
void PqlExtension::Load(ExtensionLoader &loader) {
	LoadInternal(loader);
}

std::string PqlExtension::Name() {
	return "pql";
}

std::string PqlExtension::Version() const {
#ifdef EXT_VERSION_PQL
	return EXT_VERSION_PQL;
#else
	return "";
#endif
}
...
DUCKDB_CPP_EXTENSION_ENTRY(pql, loader) {
